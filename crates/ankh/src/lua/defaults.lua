...
-- review
-- <Space> is the leader everywhere, review included: a pure prefix (there
-- is no bare-<Space> mapping), so pressing it opens which-key immediately
-- and nothing ever sits out `timeoutlen`. The progress key is <CR>, as on
-- the desktop.
